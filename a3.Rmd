...
The graph types are well-chosen for both graphs. For “Daily number of confirmed cases and deaths”, grouped bar plot is suitable for visualising the combination of numeric and categorical variables. On one hand, it presents the amount of cases and deaths numbers in bar length so it becomes easier to compare the difference in between for users. On the other hand, as it is a “grouped” bar plot, greater comparisons can be made among different groups, in this case, it is location.
