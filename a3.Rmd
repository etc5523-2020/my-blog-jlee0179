...
<br>I am not able to recognise every EU member country. With this assumption that some users might not be familiar with every EU country, I would include the flag next to each country name in the cells under the “location” column in the table. This is doable with the “reactable” package, which I had used to build the table. To do this, the items that are to be contained within the cells under “location” need to be redefined with a function and then call on “div” with “img” to follow the path where the flag image is saved. This would hopefully “decorate” the appearance of this app.
