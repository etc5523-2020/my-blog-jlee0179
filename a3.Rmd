...
*EU map*
<br>An addition I would like to include is a map for all EU countries that reveals the severity of Covid-19 conditions over all EU countries. Ideally, the severity levels can be shown by the dimension of circles according to the total cases number. Nonetheless, the dataset used does not contain longitude and latitude for all countries which is considered as a limitation in data. 
